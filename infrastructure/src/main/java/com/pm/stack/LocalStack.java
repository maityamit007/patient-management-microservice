...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService fargateService= createFargateService("AuthService", "auth-service", List.of(4005), authServiceDb, Map.of("JWT_SECRET", "zP6K8dNQyV1yJ2mLxT9uQH5sC4FvA7B0RkWnE3IhOeM="));
        authServiceDb.getNode().addDependency(authDbHealthCheck);
        authServiceDb.getNode().addDependency(authServiceDb);
        ...
        FargateService analyticService = createFargateService("AnalyticsService",
                "analytics-service",
                List.of(4002)
                        , null,
                null);
    ...
    private DatabaseInstance createDatabase(String id, String dbName) {
        return DatabaseInstance.Builder.create(this, id).engine(DatabaseInstanceEngine.postgres(PostgresInstanceEngineProps.builder().version(PostgresEngineVersion.VER_17_2).build())).
    ...
    private CfnHealthCheck createDbHealthCheck(DatabaseInstance db, String id) {
        return CfnHealthCheck.Builder.create(this, id).
                healthCheckConfig(CfnHealthCheck.HealthCheckConfigProperty.builder()
                        ...
                        .ipAddress(db.getDbInstanceEndpointPort())
                        .requestInterval(30)
                        .failureThreshold(3)
                        .build())
                .build();
    ...
    private FargateService createFargateService(String id, String imageName, List<Integer> ports, DatabaseInstance db, Map<String, String> additionalEnVars) {
